...
import com.example.application.ui.Home.*
...
class MainActivity : AppCompatActivity() {
    ...
    fun openClassFragment(){
        supportFragmentManager.beginTransaction()
            .replace(R.id.frame_layout, com.example.application.ui.Home.openClassFragment)
            .addToBackStack("null")
            .commit()
    }
    fun ReservationPlaceFragment(){
        supportFragmentManager.beginTransaction()
            .replace(R.id.frame_layout, com.example.application.ui.Home.reservationPlaceFragment)
            .addToBackStack("null")
            .commit()
    }
    fun MyRegisterPlaceFragment(){
        supportFragmentManager.beginTransaction()
            .replace(R.id.frame_layout, com.example.application.ui.Home.myRegisterPlaceFragment)
            .addToBackStack("null")
            .commit()
    }
    fun SignupClassFragment(){
        supportFragmentManager.beginTransaction()
            .replace(R.id.frame_layout, com.example.application.ui.Home.singupClassFragment)
            .addToBackStack("null")
            .commit()
    }
    ...
    fun placeFragment(){
        supportFragmentManager.beginTransaction()
            .replace(R.id.frame_layout, com.example.application.ui.Home.PlaceFragment())
            .addToBackStack("null")
            .commit()
    }
}
